...
## What's Changed
* Release Automation: Post-release sync (r2.1) by @camara-release-automation[bot] in https://github.com/camaraproject/ClickToDial/pull/117
* prepare r2.2 with Commonalities r4.4 by @YadingFang in https://github.com/camaraproject/ClickToDial/pull/119
* Sync common files from Commonalities r4.4 by @camara-release-automation[bot] in https://github.com/camaraproject/ClickToDial/pull/120
* Align ClickToDial with Commonalities r4.4 by @YadingFang in https://github.com/camaraproject/ClickToDial/pull/122
